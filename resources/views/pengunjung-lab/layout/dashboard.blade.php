...
<body class="crm_body_bg">
    <nav class="sidebar vertical-scroll ps-container ps-theme-default ps-active-y">
        <div class="logo d-flex justify-content-between">
            <a href="/pengunjung-lab/dashboard"><img src="{{ asset('assets/marketing/img/logo-hub.png') }}" alt /></a>
        ...
        <ul id="sidebar_menu">
            ...
            <li class="{{ Request::is('pengunjung-lab/dashboard*') ? 'active' : '' }}">
                <a class="nav-link" href="/pengunjung-lab/dashboard">
                    <div class="icon_menu">
            ...
            <li class="{{ Request::is('pengunjung-lab/pengajuan-kegiatan*') ? 'active' : '' }}">
                <a class="nav-link" href="/pengunjung-lab/pengajuan-kegiatan">
                    <div class="icon_menu">
            ...
            <li class="{{ Request::is('pengunjung-lab/dokumen-lab*') ? 'active' : '' }}">
                <a class="nav-link" href="/pengunjung-lab/dokumen-lab">
                    <div class="icon_menu">
            ...
            <li class="{{ Request::is('pengunjung-lab/profile') ? 'active' : '' }}">
                <a class="nav-link" href="/pengunjung-lab/profile">
                    <div class="icon_menu">
                            ...
                            <div class="profile_info">
                                ...
                                <div class="profile_info_iner">
                                    ...
                                    <div class="profile_info_details">
                                        <a href="/pengunjung-lab/profile">Profile </a>
