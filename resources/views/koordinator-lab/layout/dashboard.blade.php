...
<body class="crm_body_bg">
    <nav class="sidebar vertical-scroll ps-container ps-theme-default ps-active-y">
        <div class="logo d-flex justify-content-between">
            <a href="/koordinator-lab/dashboard"><img src="{{ asset('assets/marketing/img/logo-hub.png') }}" alt /></a>
        ...
        <ul id="sidebar_menu">
            ...
            <li class="{{ Request::is('koordinator-lab/dashboard*') ? 'active' : '' }}">
                <a class="nav-link" href="/koordinator-lab/dashboard">
                    <div class="icon_menu">
            ...
            <li class="{{ Request::is('koordinator-lab/pengajuan-kegiatan*') ? 'active' : '' }}">
                <a class="nav-link" href="/koordinator-lab/pengajuan-kegiatan">
                    <div class="icon_menu">
            ...
            <li
                class="{{ Request::is('koordinator-lab/daftar-pengunjung*') || Request::is('koordinator-lab/lihat-dokumen*') ? 'active' : '' }}">
                <a class="nav-link" href="/koordinator-lab/daftar-pengunjung">
                    <div class="icon_menu">
            ...
            <li
                class="{{ Request::is('koordinator-lab/dokumen-lab/temp*') || Request::is('koordinator-lab/dokumen-lab*') ? 'active' : '' }}">
                ...
                <ul>
                    <li class="{{ Request::is('koordinator-lab/dokumen-lab/temp*') ? 'active' : '' }}"><a
                            class="nav-links" href="/koordinator-lab/dokumen-lab/temp">Dokumen Simpan
                        </a>
                    </li>
                    <li
                        class="{{ Request::is('koordinator-lab/dokumen-lab') || Request::is('koordinator-lab/dokumen-lab-edit*') || Request::is('koordinator-lab/dokumen-lab-detail*') ? 'active' : '' }}">
                        <a class="nav-links" href="/koordinator-lab/dokumen-lab">Dokumen Lab</a>
                    </li>
                </ul>
            </li>
            <li class="{{ Request::is('koordinator-lab/profile') ? 'active' : '' }}">
                <a class="nav-link" href="/koordinator-lab/profile">
                    <div class="icon_menu">
            ...
            <li>
                <a class="nav-link" href="/koor-lab/logout">
                    <div class="icon_menu">
                            ...
                            <div class="profile_info">
                                ...
                                <div class="profile_info_iner">
                                    ...
                                    <div class="profile_info_details">
                                        <a href="/koordinator-lab/profile">Profile </a>
                                        <a href="/koor-lab/logout">Logout </a>
                                    </div>
                                </div>
                            </div>
                        </div>
