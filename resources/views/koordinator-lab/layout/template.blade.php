            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="/koordinator-lab/dashboard"><img src="{{ asset('assets/assets/img/logo/cichub.jpg') }}"
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ Request::is('koordinator-lab/dashboard*') ? 'active' : '' }}"><a class="nav-link"
                                href="/koordinator-lab/dashboard"><i class="fas fa-fire"></i>
                                <span>Dashboard</span></a></li>
                        <li class="menu-header">Kelola Data</li>
                        <li class="{{ Request::is('koordinator-lab/pengajuan-kegiatan*') ? 'active' : '' }}"><a
                                class="nav-link" href="/koordinator-lab/pengajuan-kegiatan"><i
                                    class="fas fa-book-open"></i>
                                <span>Pengajuan</span></a>
                        </li>
                        <li
                            class="{{ Request::is('koordinator-lab/daftar-pengunjung*') || Request::is('koordinator-lab/lihat-dokumen*') ? 'active' : '' }}">
                            <a class="nav-link" href="/koordinator-lab/daftar-pengunjung"><i
                                    class="fas fa-users"></i><span>Daftar Pengunjung</span></a>
                        </li>
                        <li
                            class="dropdown {{  Request::is('koordinator-lab/dokumen-lab/temp*') || Request::is('koordinator-lab/dokumen-lab*') ? 'active' : '' }}">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li
                                    ...
                                    <a class="nav-link" href="/koordinator-lab/dokumen-lab">Dokumen Lab</a>
                                </li>
                            </ul>
                        </li>
                        <li class="{{ Request::is('koordinator-lab/profile') ? 'active' : '' }}"><a class="nav-link"
                                href="/koordinator-lab/profile"><i class="fas fa-user"></i>
                                <span>Profile</span></a>
                        </li>
                        <li class="menu-header">Logout</li>
                        <li><a class="nav-link" href="/koor-lab/logout"><i class="fas fa-sign-out-alt"></i>
                                <span>Logout</span></a>
                        </li>
                    </ul>
                </aside>
